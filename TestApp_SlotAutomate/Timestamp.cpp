// Borrowed from Poco :: Timestamp and modified by me for this engine
...
const Timestamp::TimeVal Timestamp::TIMEVAL_MIN = 0;//std::numeric_limits<Timestamp::TimeVal>::min();
const Timestamp::TimeVal Timestamp::TIMEVAL_MAX = 4294967294;// std::numeric_limits<Timestamp::TimeVal>::max();
